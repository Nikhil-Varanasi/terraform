...
#we are not reaplcing var.instance_name as only count dont work in locals 
#if count is not there in statement in any case , we can use condiotion as mentioned in commmects ib local